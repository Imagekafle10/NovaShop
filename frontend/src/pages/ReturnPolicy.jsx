  ...
  return (
    <div style={textualStyle}>
      ...
      <p style={{ marginBottom: '20px' }}>
        At {process.env.REACT_APP_ORGANIZATION_NAME}, we proudly stand behind the quality of our merchandise. If for any reason you are completely disastified with your purchase, you may securely initiate a return within 30 days of receiving your order.
      </p>
