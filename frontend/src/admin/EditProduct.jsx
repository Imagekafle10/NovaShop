      ...
      <div style={styles.container}>
        ...
        <div style={styles.hero}>
          <div>
            ...
            <h2 style={styles.heroTitle}>Edit Product</h2>
            <p style={styles.heroSub}>Update details for "{formData.name}"</p>
          </div>
        </div>
          ...
          <div style={styles.imageUpload}>
            {preview ? (
              ...
              <div style={styles.previewFallback}>
                <span style={{ color: '#71717a', fontSize: '0.8rem' }}>No image</span>
              </div>
            )}
            <div style={{ flex: 1 }}>
              <label style={styles.label}>Product Image</label>
              <input type="file" accept="image/*" onChange={handleImageChange} style={styles.fileInput} />
              <p style={styles.hint}>Leave empty to keep the current image.</p>
            </div>
          </div>
